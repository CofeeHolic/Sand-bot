...
def send_telegram_message(message):
    """Sends a message to the configured Telegram chat, safely escaping Markdown characters."""
...
try:
    ...
    dhan_trade = dhanhq(DHAN_SANDBOX_CLIENT_ID, DHAN_SANDBOX_ACCESS_TOKEN, sandbox=True)
